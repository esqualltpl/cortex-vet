...
class AuthenticationController extends Controller
{
    ...
    {
        return view('neurologist.authentication.signup');
    }
    ...
    public function signUpSave(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            Log::info('Successfully signup new neurologist user', ['message' => 'success']);
            flash()->success('Your account has been registered successfully, Please complete your profile.');
            return redirect()->route('neurologist.dashboard');
        } catch (\Exception $e) {
            Log::info('The system is unable to create the new neurologist user now. Please try again later.', ['message' => $e->getMessage(), 'error' => $e]);
            flash()->error('The system is unable to create the new neurologist user now. Please try again later.');
