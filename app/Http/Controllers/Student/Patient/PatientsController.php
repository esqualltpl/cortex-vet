...
namespace App\Http\Controllers\Student\Patient;
...
class PatientsController extends Controller
{
    public function index(): \Illuminate\Contracts\View\Factory|\Illuminate\Contracts\View\View|\Illuminate\Contracts\Foundation\Application
    {
        ...
        return view('student.patients.index', compact('patients'));
    }
    ...
    public function detail($id): \Illuminate\Contracts\View\Factory|\Illuminate\Contracts\View\View|\Illuminate\Contracts\Foundation\Application
    {
        ...
        return view('student.patients.detail', compact('patientInfo', 'species', 'breedsSelectedSpecie', 'appointmentsHistory'));
    }
    ...
    public function neuroExamDetail($id, $no): \Illuminate\Contracts\View\Factory|\Illuminate\Contracts\View\View|\Illuminate\Contracts\Foundation\Application
    {
        ...
        return view('student.patients.neuro_exam_detail', compact('mainFirstVideo','neuroExamInfo', 'neuro_exam_no', 'examsInfo'));
    }
    ...
    public function sendDetailReport(Request $request)
    {
        try {
            ...
            $examsInfo = Exam::where('added_by', $admin_id)->with('testInfo', 'instructionVideoInfo')->get();
            $html = view('student.patients.render.pdf_data', compact('neuroExamInfo', 'examsInfo',))->render();
            ...
            //----Send Email----\\
            $emailTemplate = 'student.patients.render.email_data';
