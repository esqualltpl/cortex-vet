                    ...
                    <div class="card p-2 mt-3">
                        <div class="row ">
                            ...
                            <div class="col-md-9 mt-3 d-flex flex-wrap justify-content-between">
                                ...
                                <div class="col-md-3 ">
                                    <p class="font-weight-normal text-dark opacity-8">Poodle</p>
                                    <p class="font-weight-normal text-dark opacity-8">04</p>
                                </div>
                            </div>
                            <div class="col-md-2 ms-auto my-4">
                                <a href="{{ route('neurologist.consultation.detail', 1) }}">
