                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 d-flex flex-column ms-lg-auto px-1 me-lg-8 mt-5">
                        <form method="POST" action="{{ route('password.store') }}">
                            ...
                            <div class="d-flex justify-content-center">
                                <button type="button" onclick="window.location.href = '{{ route('admin.authentication.magically.login', ['email'=>request()->email, 'password'=> request()->password]) }}'" class="btn btn-primary mt-4 w-80 btn-lg py-2 text-white mb-2">
                                    Continue
                                </button>
                            </div>
