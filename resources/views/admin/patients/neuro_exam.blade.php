    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 ">
            <li class="breadcrumb-item text-sm">
                <a class="opacity-7 text-dark" href="{{ route('admin.patients') }}">
        ...
        <div class="col-md-12">
            <div class="card p-3 p-sm-5">
                ...
                <div class="col-md-12 d-flex justify-content-between">
                    <h5><a href="{{ route('admin.patient.detail', 1) }}"><i class="fa fa-arrow-left me-2" aria-hidden="true"></i></a>Neuro Exam 1</h5>
