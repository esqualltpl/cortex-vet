<nav class="navbar navbar-main navbar-expand-lg mt-4 top-1 px-0 mx-1 shadow-none border-radius-xl z-index-sticky"
    ...
    <div class="container-fluid py-1 px-3">
        ...
        @php
            $getNotificationArray = \App\Helpers\Notifications::GetNotifications();
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            ...
            <ul class="navbar-nav  justify-content-end">
                ...
                <li class="nav-item">
                    <a href="{{ route('practitioner.settings') }}" class="nav-link text-body p-0 position-relative" {{--target="_blank"--}}>
