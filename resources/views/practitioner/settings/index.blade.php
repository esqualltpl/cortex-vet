                                            ...
                                            <form id="save-profile-info-form">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <span id="profile-image-hide">
                                                        ...
                                                        <input type="file" id="fileInput" style="display: none;" data-action-url="{{ route('practitioner.setting.update.profile.image') }}">
                                                    </span>
                                                ...
                                                <div class="d-flex mt-4"
                                                    ...
                                                    <div>
                                                        ...
                                                        <button type="button"
                                                                data-action-url="{{ route('practitioner.setting.update.profile') }}"
                                            ...
                                            <div class="row">
                                                <form id="change-password-info-form">
                                                    ...
                                                    <div class="d-flex mt-3" style="justify-content:end; align-items: center;">
                                                        <div>
                                                            <button type="button"
                                                                    data-action-url="{{ route('practitioner.setting.change.profile.password') }}"
