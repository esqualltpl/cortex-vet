            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-xl-5 col-lg-5 col-md-5 d-flex flex-column ms-lg-auto px-1 me-lg-6 mt-5">
                        <form action="{{ route('practitioner.authentication.sign.up.save') }}" method="post">
                            @csrf
                            <h3 class="mb-2">Sign Up</h3>
                            <p class="text-sm mb-4">Already have an account?
                                <a href="{{ route('practitioner.authentication.login') }}" class="text-info font-weight-bold" style="text-decoration: none;">Sign In</a>
                            </p>
